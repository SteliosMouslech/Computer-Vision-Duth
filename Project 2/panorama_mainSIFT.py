...
dimg1 = cv.drawMatches(img1, desc1[0], img2, desc2[0], matches1, None)
cv.namedWindow('dimg1',cv.WINDOW_NORMAL)
...
dimg2 = cv.drawMatches(img3, desc3[0], img4, desc4[0], matches2, None)
cv.namedWindow('dimg2',cv.WINDOW_NORMAL)
...
dimg3 = cv.drawMatches(img6, desc6[0], img5, desc5[0], matches3, None)
cv.namedWindow('dimg3',cv.WINDOW_NORMAL)
cv.imshow('dimg3', dimg3)
cv.waitKey(0)
