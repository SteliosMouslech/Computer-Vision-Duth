...
img1 = cv.imread('mine00.jpg', cv.IMREAD_GRAYSCALE)
...
img2 = cv.imread('mine01.jpg',cv.IMREAD_GRAYSCALE)
...
img3 = cv.imread('mine02.jpg',cv.IMREAD_GRAYSCALE)
img3 = cv.resize(img3,None,fx=0.5,fy=0.5)

kp3 = sift.detect(img3)
desc3 = sift.compute(img3, kp3)

img4 = cv.imread('mine03.jpg',cv.IMREAD_GRAYSCALE)
